            ...
            conditionalPanel(
              ...
              tabBox(
                ...
                tabPanel(
                  ...
                  fluidRow(
                    column(9, box(width=12,title="Eigen values table",status="danger",solidHeader = TRUE,verbatimTextOutput("eigenvaluesTable"))),
                    column(3,
          ...
          conditionalPanel(
            ...
            box(width = 8,title="Clustering options",status="danger",solidHeader = TRUE,
                fluidRow(
                  ...
                  column(3, tags$div(style="margin-left: auto;margin-right: auto;",actionButton("clusteringSubmit", "Submit")))
                )),
            conditionalPanel(
          ...
          conditionalPanel(
            ...
            tabBox(
              ...
              tabPanel(title = "Cluster",
                       fluidRow(
                         box(width=10, title="Plot of clusters",status="danger", solidHeader=TRUE,shinycssloaders::withSpinner(plotOutput("groupe", height = "900px"),type = getOption("spinner.type", default = 6),
                                                                                                                              color = getOption("spinner.color", default = "#d73925"))),
                         box(width=2,title="Clusters repartition",status="danger", solidHeader=TRUE,verbatimTextOutput("effecCluster")),
                         downloadButton("downloadGroupPlot")
                       )
                       
              ),
              tabPanel(title = "Descriptive statistics by cluster",
                       fluidRow(
                         column(4,
                                tags$div(
                                  selectizeInput(
